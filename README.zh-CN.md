...
Termite 目前主要在维护者的以下工作站上开发与验证：

| 项目 | 环境 |
| --- | --- |
| 硬件 | MacBook Pro · Apple M5 Max（18 核）· 48 GB 统一内存 |
| macOS | macOS 27.0 · 构建版本 26A5406e |
| 工具链 | Xcode 26.6 · Swift 6.3.3 · XcodeGen 2.46.0 |
| Shell | zsh 5.9 |
| 移动端验证 | iOS 27.0 模拟器 |

> 以上是主要开发环境，并非最低配置要求。Mac 端的兼容基线仍为 **macOS 26.0+**，移动端仍为 **iOS / iPadOS 17.0+**。
